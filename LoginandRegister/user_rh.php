...
include_once('Login and Register/connection.php');

if(isset($_POST['user_rh']))
{
    $name=$_POST['name'];
    $username=$_POST['username'];
    $cin_num = $_POST['cin_num'];
    $domaine_activite = $_POST['domaine_activite'];
    $poste = $_POST['poste'];
    $password=md5($_POST['password']);


    $sql="INSERT INTO table_utilisateurs (nom_complet, email, num_cin, domaine_activite, poste, mot_de_passe)
    VALUES (:nom_complet, :email, :num_cin, :domaine_activite, :poste, :mot_de_passe)";

    $result = mysqli_query($conn, $sql);
    if($result){ 
        header('location:user_rh.php');
                  ...
                  <form class="mx-1 mx-md-4" action="add.php" method="post">
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <label class="form-label" for="form3Example1c"><i class="bi bi-person-circle"></i> Nom rh</label>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        ...
                        <input type="email" id="form3Example3c" class="form-control form-control-lg py-3" name="username" autocomplete="off" placeholder="Entrez l'email" style="border-radius:25px ;" />
