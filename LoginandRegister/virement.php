                  ...
                  <form class="mx-1 mx-md-4" action="add.php" method="post">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        ...
                        <input type="text" id="form3Example3c" class="form-control form-control-lg py-3" name="username" autocomplete="off" placeholder="Entrez votre Email" style="border-radius:25px ;" />
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        ...
                        <input type="text" id="form3Example4c" class="form-control form-control-lg py-3" name="password" autocomplete="off" placeholder="Entrez votre Mot de passe" style="border-radius:25px ;" />
                      </div>
                    </div>
